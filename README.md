...
## 目指した問題解決
 ...
 <br>同世代の方を見つけたり、出荷しているものが同じといった、農業の仲間を見つける事ができ、気軽にコミュニケーションをとれる場所があれば良いのではないかと思いました。特に若者世代の方はSNSでのコミュニケーションが主流となっており、地域以外の方々にも成果物を発表できる場所や農業に関する発言ができるSNSがあれば良いのではないかと考えました。
 <br>そして、農作業で人手が足りない時、親戚や知人に連絡をとり日程を調整するのには手間がかかります。地域でその日都合がつく方が農作業のお手伝いができる機能があればと思い、人手を募集に関する項目を投稿機能に追加しようと考えました。
